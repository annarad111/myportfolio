  ...
  return (
    <section className={styles.section} id="work">
      ...
      <div className={styles.header}>
        <span className={styles.label}>02 — Work / Developer</span>
        ...
        {devProjects.map((project, i) => (
          <article key={project.id} className={`${styles.card} gsap-reveal`}>
            ...
            <div className={styles.cardContent}>
              ...
              {/* Imagini DOAR pe primul card */}
              {i === 0 && (
                <div className={styles.cardImages}>
                  <Image
                    src="/olympian-odds.png"
                    alt="Olympian Odds"
                    width={160}
                    height={160}
                  ...
                  <Image
                    src="/meteors.jpeg"
                    alt="Meteors and Rockets"
                    width={120}
                    height={120}
                    className={`${styles.cardImg} ${styles.cardImgSecond}`}
                  />
                </div>
              )}
